...
function DevsScreen() {
  ...
  const [customAgents, setCustomAgents] = useState<Array<{ name: string; skill: string; input: string; output: string }>>([]);
